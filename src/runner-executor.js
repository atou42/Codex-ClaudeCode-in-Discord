...
export function createRunnerExecutor({
  ...
  const { buildSessionRunnerArgs } = createRunnerArgsBuilder({
    ...
    codexModelContextWindowModel,
    codexModelContextWindows,
    codexModelCompactTokenLimits,
  ...
  const codexAppServerRunner = createCodexAppServerRunnerFn({
    ...
    resolveCompactEnabledSetting,
    resolveNativeCompactTokenLimitSetting,
    modelContextWindow: codexModelContextWindow,
    modelContextWindowModel: codexModelContextWindowModel,
    modelContextWindows: codexModelContextWindows,
    modelCompactTokenLimits: codexModelCompactTokenLimits,
    modelCatalogJson: codexModelCatalogJson,
    resolveTimeoutSetting,
    normalizeTimeoutMs,
    safeError,
    stopChildProcess,
